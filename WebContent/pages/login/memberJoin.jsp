			...
			<table>
				<tr>
					<td width="400" style="padding: 30px"><input type="radio"
						name="role" value="2" checked="checked" style="position: inherit;">일반
						회원 <input type="radio" name="role" value="1"
				...
				<tr>
					<td width="400">
					<!--  생년월일 입력 오늘 이후로는 기입할 수 없음 -->
						<input type="date" id="bd" max="${date}" name="birthdate">	
					</td>
				</tr>
				<tr>
